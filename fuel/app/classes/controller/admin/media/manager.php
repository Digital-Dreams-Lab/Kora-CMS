...
class Controller_Admin_Media_Manager extends Controller_Rest
{
	/*
	...
	public function set_media_data()
	{
		...
		$this->media_list = $media->get_list($this->folder_id, false, $this->pagination->offset, $this->pagination->per_page);
	}
