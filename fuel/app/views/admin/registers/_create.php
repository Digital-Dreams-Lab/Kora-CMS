...
<div class="form-group">
	...
	<?php echo Form::select('type', Input::post('type',''), $types, array('class' => 'form-control')); ?>
</div>
...
<div class="form-group">
	...
	<?php echo Form::input('route', Input::post('route',''), array('class' => 'form-control', 'placeholder'=>'Route', 'id'=>'route_set')); ?>
</div>
...
<div class="form-group">
	...
	<?php echo Form::input('controller', Input::post('controller',''), array('class' => 'form-control', 'placeholder'=>'Controller', 'id'=>'controller_set')); ?>
</div>
...
<div class="form-group">
	...
	<?php echo Form::input('actions', Input::post('actions',''), array('placeholder'=>' Write actions then click enter or comma', 'id'=>'tokenfield_actions')); ?>
</div>

<div class="form-group">
    <label class='control-label'>Methods <span class="text-info">Eg. POST,GET,PUT,DELETE</span></label>
	<?php echo Form::input('methods', Input::post('methods',''), array('class' => 'tokenfield', 'placeholder'=>' Write methods then click enter or comma')); ?>
</div>

<div class="form-group">
    <label class='control-label'>Permissions</label>
	<?php echo Form::input('perms', Input::post('perms',''), array('class' => 'tokenfield', 'placeholder'=>' Write permissions then click enter or comma', 'id'=>'perms_get')); ?>
</div>

<div class="form-group">
    <label class='control-label'>Rules</label>
	<?php echo Form::input('rules', Input::post('rules',''), array('class' => 'tokenfield', 'placeholder'=>' Write rules then click enter or comma')); ?>
</div>

<div class="form-group">
    <button type="submit" class="btn btn-warning">
        <i class="fa fa-save"></i> Save registry rules
    </button>
</div>
