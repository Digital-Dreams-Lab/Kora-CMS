...
$navbar = array(
		...
		'addons'		=>array('Add-ons',		'puzzle-piece',	"Manage plugins, modules and templates.",	array('modules','themes','plugins')),
		'settings'		=>array('Settings',		'cog',			"Manage site settings.",					array('accounts','notifications')),
		//'tools'			=>array('Tools',		'wrench',		"Manage admin tools.",						array()),
		'permissions'	=>array('Permissions',	'lock',			"Manage site permissions.",					array('groups','users','access','registers')),
	);
?>
