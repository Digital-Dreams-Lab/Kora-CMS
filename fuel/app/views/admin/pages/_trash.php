...
<table class="table table-striped vert-align">
	<thead>
		<tr>
			...
			<th>Author</th>
			<th>Created</th>
			<th class="text-right"><?php echo Kora\Permissions::get_link('admin/pages', 'all', '<i class="fa fa-trash-o fa-fw"></i> Empty trash', 'delete', array('data-toggle'=>"tooltip", 'data-placement'=>"top", 'title'=>"Perminantly delete pages.", 'onclick' => "return confirm('Are you sure you want to perminantly delete these pages?')")); ?></th>
		</tr>
	</thead>
	<tbody>    
		<?php foreach ($pagetree as $item): ?>
		<tr>
			<td><?php echo ((isset($item['depth']) && $item['depth'] > 0) ? str_repeat('<span class="text-muted"><i class="fa fa-arrow-right"></i> </span>', $item['depth']): '').'<span class="text-muted"><i class="fa fa-file-trash-o"></i></span> '; ?>
			...
			<td class="text-right">
				...
				<?php echo Kora\Permissions::get_link('admin/pages', $item['data']['id'], '<i class="fa fa-trash-o fa-fw"></i>', 'delete', array('class'=>'btn btn-xs btn-danger', 'data-toggle'=>"tooltip", 'data-placement'=>"top", 'title'=>"Perminantly delete page.", 'onclick' => "return confirm('Are you sure you want to perminantly delete this page?')")); ?>
            </td>
		</tr>
		<?php endforeach; ?>
	</tbody>
