...
<table class="table table-striped vert-align">
	...
	<tbody>    
		...
		<tr>
			<td><?php echo ((isset($item['depth']) && $item['depth'] > 0) ? str_repeat('<span class="text-muted"><i class="fa fa-arrow-right"></i> </span>', $item['depth']): '').'<span class="text-muted"><i class="fa fa-file-o"></i></span> '; ?>
            ...
            <td><?php echo Kora\Permissions::get_link('admin/pages', $item['data']['id'], '<i class="fa fa-cog fa-fw"></i>', 'settings', array('class'=>'btn btn-xs btn-default', 'data-toggle'=>"tooltip", 'data-placement'=>"top", 'title'=>"Edit page settings.")); ?></td>
			<td class="text-right">
				<?php echo Kora\Permissions::get_link('admin/pages', $item['data']['id'], '<i class="fa fa-eye fa-fw"></i>', 'view', array('class'=>'btn btn-xs btn-info', 'data-toggle'=>"tooltip", 'data-placement'=>"top", 'title'=>"View page.")); ?>
