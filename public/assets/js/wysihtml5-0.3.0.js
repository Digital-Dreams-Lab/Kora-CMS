...
(function(wysihtml5) {
  ...
  wysihtml5.commands.alignObject = {

    exec: function(composer, command, element_class) {
      var element_class=element_class.split(/:/);
      var element=element_class[0];
      var newclass=element_class[1];
...
(function(wysihtml5) {
  ...
  wysihtml5.Editor = wysihtml5.lang.Dispatcher.extend(
    ...
    constructor: function(textareaElement, config) {
      ...
      try {
        console.log("https://github.com/xing/wysihtml5");
      } catch(e) {}
    },
