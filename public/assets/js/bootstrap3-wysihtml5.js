    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
                ...
                "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='' tabindex='-1'>" + locale.font_styles.normal + "</a></li>" +
        ...
        "align": function(locale, options) {
            ...
            return "<li>" +
                "<div class='btn-group'>" +
                //"<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='alignObject' data-wysihtml5-command-value='p:text-left' title='" + locale.align.left + "' tabindex='-1'><i class='fa fa-paragraph'></i></a>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='alignObject' data-wysihtml5-command-value='span:wysiwyg-text-align-left' title='" + locale.align.left + "' tabindex='-1'><i class='glyphicon glyphicon-align-left'></i></a>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='alignObject' data-wysihtml5-command-value='span:wysiwyg-text-align-center' title='" + locale.align.center + "' tabindex='-1'><i class='glyphicon glyphicon-align-center'></i></a>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='alignObject' data-wysihtml5-command-value='span:wysiwyg-text-align-right' title='" + locale.align.right + "' tabindex='-1'><i class='glyphicon glyphicon-align-right'></i></a>" +
                "</div>" +
                "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            return ''; 
				//"<li>" +
				//"<a class='btn btn-" + size + " btn-default' title='" + locale.image.insert + "' tabindex='-1' data-toggle='modal' data-target='#media-modal'><i class='glyphicon glyphicon-picture'></i></a>" +
                //"</li>";
        },
/*
        "image": function(locale, options) {
